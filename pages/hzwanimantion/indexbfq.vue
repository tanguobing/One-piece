<template>
	<view class="audo-video">
		<video id="myVideo" :src="urls" class="hidden" @timeupdate="timeupdate" ref="video" @loadedmetadata="loadedmetadata" ></video>
...
<script>
	const url = 'https://img-cdn-qiniu.dcloud.net.cn/uniapp/audio/music.mp3';
	export default {
		data() {
			return {
				urls:url,
